...
namespace GuamanJordan_PruebaParcial2
{
    public partial class frmBresenhamLines : Form
    {
        ...
        private void frmBresenhamLines_Load(object sender, EventArgs e)
        {
            DibujarGrid();
        }
        ...
        private async void panelCanvas_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            else if (puntoFin == null)
            {
                ...
                if (!CBresenhamLines.ValidarCoordenadas(puntoInicio.Value.X, puntoInicio.Value.Y, puntoFin.Value.X, puntoFin.Value.Y, panelCanvas.Width, panelCanvas.Height, ESCALA_GRID))
                {
                ...
                puntosLinea = CBresenhamLines.CalcularPuntosBresenham(puntoInicio.Value.X, puntoInicio.Value.Y, puntoFin.Value.X, puntoFin.Value.Y, ESCALA_GRID, panelCanvas.Height);
